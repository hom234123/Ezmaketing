...
<head>
<title>Số điện thoại | Maketing</title>
<meta charset="utf-8">
								...
								<c:forEach var="L" items="${Lead}">
									<tr>
										...
										<td><a onclick="return confirm('Bạn có muốn xóa không?')"
											class="btn btn-danger" href="deleteleadmkt?LeadID=${L.getLeadID()}">Xóa</a>
											<a class="btn btn-success" href="editleadmkt?LeadID=${L.getLeadID()}">Sửa</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
