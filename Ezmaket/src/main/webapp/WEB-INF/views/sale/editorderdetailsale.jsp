...
<head>
<title>Sửa chi tiết đơn| Sale</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="tile">
					...
					<div class="tile-body">
						<f:form action="updateorderdetailsale" method="post" modelAttribute="orderDetails"
							class="row">
							...
							<div class="form-group col-md-3">
								...
								<f:input class="form-control"  path="OrderID" readonly="true" />
