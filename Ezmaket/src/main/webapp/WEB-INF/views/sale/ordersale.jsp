						...
						<div class="row element-button">
							<div class="col-sm-2">
								<a class="btn btn-add btn-sm"
									href="addordersale" title="Thêm"><i
									></i> Tạo mới đơn hàng</a>
							</div>
							<div class="col-sm-2">
								
								<a class="btn btn-add btn-sm"
									href="addorderdetailsale" title="Thêm"><i
								...
								<c:forEach var="O" items="${Orders}">
									<tr>
										...
										<td>
											...
											class="btn btn-danger" href="deleteordersale?OrderID=${O.getOrderID()}">Xóa</a>
											<a class="btn btn-success" href="editordersale?OrderID=${O.getOrderID()}">Sửa</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
								...
								<table class="table table-bordered" id="orderTable">
									...
									<tbody>
										<c:forEach var="OR" items="${OrderDetails}">
											...
											class="btn btn-danger" href="deleteorderdetailsale?OrderDetailID=${OR.getOrderDetailID()}">Xóa</a>
											<a class="btn btn-success" href="editorderdetailsale?OrderDetailID=${OR.getOrderDetailID()}">Sửa</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
