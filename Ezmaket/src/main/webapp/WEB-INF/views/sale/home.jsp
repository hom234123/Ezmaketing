				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="widget-small primary coloured-icon">
							...
							<div class="info">
								<h4>Tổng số điện thoai</h4>
								<p>
									<b>${totalLead} số điện thoai</b>
								</p>
								<p class="info-tong">Tổng số điện thoai .</p>
							</div>
						</div>
					</div>					
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="widget-small primary coloured-icon">
							...
							<div class="info">
								<h4>Tổng đơn hàng</h4>
								<p>
									<b> ${totalOrders} khách hàng</b>
								</p>
								<p class="info-tong">Tổng số thành công.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="widget-small danger coloured-icon">
							...
							<div class="info">
								...
								<p class="info-tong">Cuộc gọi đã thực hiện.</p>
							</div>
						</div>
					</div>
					<div class="col-md-12">
