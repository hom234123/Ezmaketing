					...
					<div class="tile-body">
						<div class="row element-button">
							<div class="col-sm-2">
								...
								<a class="btn btn-add btn-sm" href="addphonecallsale"
									title="Thêm">Tạo mới cuộc gọi</a>
							</div>
						</div>
								...
								<c:forEach var="Ph" items="${PhoneCall}">
									<tr>
										...
										<td><a onclick="return confirm('Bạn có muốn xóa không?')"
											class="btn btn-danger" href="deletephonesale?CallID=${Ph.getCallID()}">Xóa</a>
											<a class="btn btn-success" href="editphonecallsale?CallID=${Ph.getCallID()}">Sửa</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
