...
<head>
<title>Thêm cuộc gọi | Sale</title>
<meta charset="utf-8">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="tile">
					...
					<div class="tile-body">
						<f:form class="row" action="savephonecallsale" method="post"
							modelAttribute="phonecall">
							<div class="form-group col-md-2">
								<label for="exampleSelect1" class="control-label">Mã
									cuộc gọi</label> <select name="LeadID" class="form-control" id="LeadID">
									<option>Chọn Mã điện thoại</option>
							...
							<div class="form-group col-md-4">
								...
								<button class="btn btn-cancel" type="button"
									onclick="window.location.href='addphonecallsale'">Hủy
									bỏ</button>
							</div>
						</f:form>
