...
<head>
<title>Sửa chi tiết đơn| Admin</title>
<meta charset="utf-8">
	...
	<main class="app-content">
		<div class="app-title">
			<ul class="app-breadcrumb breadcrumb">
				...
				<li class="breadcrumb-item"><a href="#">Sửa chi tiết</a></li>
			</ul>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="tile">
					...
					<h3 class="tile-title">Sửa chi tiết đơn</h3>
					<div class="tile-body">
						<f:form action="updateorderdetail" method="post" modelAttribute="orderDetails"
							class="row">
							<div class="form-group col-md-1">
								<label class="control-label">Mã</label>
								<f:input class="form-control" path="OrderDetailID" readonly="true" />
							</div>
							<div class="form-group col-md-3">
								...
								<select name="OrderID" class="form-control" id="OrderID">
									...
									<option value="${orders.orderID}"
											${orders.orderID == orderDetails.orderID ? 'selected' : ''}>${orders.orderID}</option>
									</c:forEach>
								</select>
							</div>
							...
							<div class="form-group col-md-3">
								...
								<select name="ProductID" class="form-control" id="ProductID">
									...
									<option value="${product.productID}"
											${product.productID == orderDetails.productID ? 'selected' : ''}>${product.productName}</option>
