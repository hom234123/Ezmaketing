				...
				<div class="tile">
					<div class="tile-body">
						<div class="row element-button">
							<div class="col-sm-2">
								<a class="btn btn-add btn-sm" href="addaccount"
									title="Thêm">Tạo mới nhân viên</a>
							</div>
						</div>
								...
								<c:forEach var="Ac" items="${Account}">
									<tr>
										...
										<td><a onclick="return confirm('Bạn có muốn xóa không?')"
											...
											href="deleteaccount?Accountid=${Ac.getAccountid()}">Xóa</a> <a
											class="btn btn-success"
											href="editaccount?Accountid=${Ac.getAccountid()}">Sửa</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
