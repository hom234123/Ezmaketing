		...
		<div class="row">
			<div class="col-md-12">
				<div class="tile">
					...
					<div class="tile-body">
						<f:form class="row" action="updateproduct"
							...
							<div class="form-group col-md-1">
								<label for="exampleSelect1" class="control-label">Thể
									loại</label> <select class="form-control" id="CategoryID"
									name="CategoryID">
									<c:forEach items="${Categorylist}" var="C">
										<!-- Nếu ID danh mục của sản phẩm trùng với ID của danh mục hiện tại, đánh dấu mục đó là 'selected' -->
										<option value="${C.categoryID}"
											${C.categoryID == product.categoryID ? 'selected' : ''}>${C.categoryName}</option>
									</c:forEach>
								</select>
							</div>
							<div class="form-group col-md-1">
							...
							<div class="form-group col-md-2">
								...
								<f:input class="form-control" type="text" path="SalePrice" />
							</div>
							<div class="form-group col-md-2">
								<label class="control-label">Tổng tiền</label>
								<f:input class="form-control" type="text" path="TotalPrice" />
							</div>
							<div class="form-group col-md-4">
								<label class="control-label">Trạng thái</label>
								<f:input class="form-control" type="text" path="status" />
							</div>
							<div class="form-group col-md-4">
