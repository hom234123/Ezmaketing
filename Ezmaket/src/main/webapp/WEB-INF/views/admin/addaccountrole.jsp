...
<body onload="time()" class="app sidebar-mini rtl">
	<header class="app-header">
		<ul class="app-nav">
			...
			<li><a class="app-nav__item " href="workreport">Báo cáo</a></li>
			<!-- User Menu-->
	...
	<main class="app-content">
		<div class="app-title">
			<ul class="app-breadcrumb breadcrumb">
				...
				<li class="breadcrumb-item"><a href="#">Phân mới</a></li>
			</ul>
			<div id="clock"></div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="tile">
					<h3 class="tile-title">Phân mới quyền</h3>
					<div class="tile-body">
						<f:form class="row" action="saveaccountrole" method="post" modelAttribute="accountrole">											
