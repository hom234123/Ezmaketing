...
<body onload="time()" class="app sidebar-mini rtl">
	...
	<main class="app-content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tile">
					<h3 class="tile-title">Sửa quyền</h3>
					<div class="tile-body">
						<f:form class="row" action="updateaccountrole" method="post"
							modelAttribute="accountrole">
							<div class="form-group col-md-4">
								<label class="control-label">Vai trò</label> <select name="role"
									class="form-control" id="role">
									<c:forEach var="role" items="${RoleList}">
										<option value="${role.roleid}"
											<c:if test="${role.roleid == accountrole.role.roleid}">selected</c:if>>
							...
							<div class="form-group col-md-4">
								...
								<f:input class="form-control" type="text" path="account" readonly="true" /> 
