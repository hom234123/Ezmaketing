...
<head>
<title>Sửa cuộc gọi | Admin</title>
<meta charset="utf-8">
	...
	<main class="app-content">
		<div class="app-title">
			<ul class="app-breadcrumb breadcrumb">
				...
				<li class="breadcrumb-item"><a href="#">Sửa cuộc gọi</a></li>
			</ul>
		</div>
		<div class="row">
			<div class="col-md-12">
				...
				<div class="tile">
					...
					<h3 class="tile-title">Sửa cuộc gọi</h3>
					<div class="tile-body">
						<f:form class="row" action="updatephonecall" method="post" modelAttribute="phonecall">
							<div class="form-group col-md-1">
								<label class="control-label">Mã</label>
								<f:input class="form-control" path="CallID" readonly="true"/>
							</div>
							<div class="form-group col-md-2">
								<label for="exampleSelect1" class="control-label">Mã cuộc gọi</label> 
									...
									<c:if test="${not empty phonecall}">
										<option value="${phonecall.leadID}" selected>${phonecall.leadID}</option>
									</c:if>
							...
							<div class="form-group  col-md-2">
								...
								<select	name="Accountid" class="form-control" id="Accountid">
									<c:forEach items="${AccountList}" var="Account">
										<!-- Nếu ID danh mục của sản phẩm trùng với ID của danh mục hiện tại, đánh dấu mục đó là 'selected' -->
										<option value="${Account.accountid}"
											${Account.accountid == phonecall.accountid ? 'selected' : ''}>${Account.fullname}</option>
									</c:forEach>
							...
							<div class="form-group col-md-2">
								...
								<f:input class="form-control" type="date" path="CallDate"/>
							</div>
							<div class="form-group col-md-2">
