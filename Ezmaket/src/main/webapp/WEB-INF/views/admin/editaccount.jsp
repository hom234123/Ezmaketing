		...
		<div class="row">
			<div class="col-md-12">
				<div class="tile">
					...
					<div class="tile-body">
						<f:form class="row" action="updateaccount"
							modelAttribute="account" method="post">
							<div class="form-group col-md-2">
								<label class="control-label">Mã nhân viên</label>
								<f:input class="form-control" path="accountid" readonly="true" />
							</div>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-1">
								<label class="control-label">Giới tính</label> <select
									...
									<option value="1"
										${account.gender == 1 ? 'selected="selected"' : ''}>Nam</option>
									<option value="0"
										${account.gender == 0 ? 'selected="selected"' : ''}>Nữ</option>
								</select>
							</div>
							<div class="form-group col-md-2">
							...
							<div class="form-group col-md-3">
								...
								<f:input class="form-control" type="text" path="passWord" />
							</div>
							<div class="form-group col-md-3">
							...
							<div class="form-group col-md-2">
								<label class="control-label">Trạng thái</label> <select
									...
									<option value="1"${account.status == 1 ? 'selected="selected"' : ''}>Đang làm</option>
									<option value="0"${account.status == 0 ? 'selected="selected"' : ''}>Nghỉ</option>
								</select>
							</div>
