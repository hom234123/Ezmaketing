...
<head>
<title>Thêm mới đơn| Admin</title>
<meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="tile">
					...
					<div class="tile-body">
						<f:form action="saveorder" method="post" modelAttribute="orders"
							class="row">
							...
							<div class="form-group col-md-3">
								...
								<f:input class="form-control" type="date" path="OrderDate" id="orderdateup"  />
							</div>
							<div class="form-group col-md-3">
							...
							<div class="form-group col-md-3">
								...
								<button class="btn btn-cancel" type="button" onclick="window.location.href='addorder">Hủy
									bỏ</button>
							</div>
						</f:form>
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			...
			document.getElementById('orderdateup').value = today;
		});
	</script>
